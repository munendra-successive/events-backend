...
class Controller {
  get = async (req: Request, res: Response): Promise<any> => {
    try {
      ...
      logger.error(`Event Cotroller - get  error:${error}`);
      return res
        .status(500)
        .send(
  ...
  getBulk = async (req: Request, res: Response): Promise<any> => {
    try {
      ...
      logger.error(`Event Controller - getBulk error:${error}`);
      return res
        .status(500)
        .send(
          SystemResponse.getErrorResponse(
  ...
  add = async (req: Request, res: Response): Promise<any> => {
    try {
      ...
      logger.error(`Event Controller - add/create error:${error}`);
  ...
  getById = async (req: Request, res: Response): Promise<any> => {
    try {
      ...
      logger.error(`Event Controller - getById error: ${error}`);
      return res
        .status(500)
        .send(
          SystemResponse.getErrorResponse(
            error?.message || "Error in finding an event by id",
            error
          )
        );
    }
